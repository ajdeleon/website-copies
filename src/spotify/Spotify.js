...
const Spotify = () => (
  <div className="main">
    ...
    <div className="flex items-center h5 mv7 ml4">
      <div className="w-80">
        <div>
    ...
    <div className="footer flex justify-center bg-black white">
      <div className="wrapper flex w-60">
        <h1>Spotify</h1>
        <div className="ml5">
        ...
        <div className="mt4">
          <div className="">
              ...
              <svg id="instagram-icon" viewBox="0 0 448 448" width="100%" height="100%" fill="white" overflow="hidden">
